...
import com.example.food_firebase.model.Chef;
...
public class chef_postDish extends AppCompatActivity {
    ...
    Button post_dish;
    Spinner Dishes;
    TextInputLayout desc,qty,pri,namedish;
    String descrption,quantity,price,dishes,name;
    Uri imageuri;
...
//        databaseReference = firebaseDatabase.getInstance().getReference("FoodDetails");
            ...
            dataa.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    post_dish.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            name = namedish.getEditText().getText().toString().trim();
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            FoodDetails info = new FoodDetails(name,quantity,price,descrption,String.valueOf(uri),RandomUID,chefid);
    ...
    private boolean isValid() {
        ...
        if(TextUtils.isEmpty(name)){
            namedish.setErrorEnabled(true);
            namedish.setError("Name dish is Required");
        }else{
            desc.setError(null);
